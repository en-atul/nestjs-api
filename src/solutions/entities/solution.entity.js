...
var Solution = /** @class */ (function (_super) {
    ...
    Solution._OPENAPI_METADATA_FACTORY = function () {
    ...
    __decorate([
        (0, mongoose_1.Prop)()
    ], Solution.prototype, "salary");
    __decorate([
        (0, mongoose_1.Prop)()
    ], Solution.prototype, "location");
    __decorate([
        (0, mongoose_1.Prop)()
    ], Solution.prototype, "description");
    __decorate([
        (0, mongoose_1.Prop)()
    ], Solution.prototype, "createdAt");
    __decorate([
        (0, mongoose_1.Prop)()
    ], Solution.prototype, "updatedAt");
    Solution = __decorate([
        (0, mongoose_1.Schema)()
    ], Solution);
    return Solution;
