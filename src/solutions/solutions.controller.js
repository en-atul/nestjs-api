...
var SolutionsController = /** @class */ (function () {
    ...
    SolutionsController.prototype.create = function (body) {
        return this.solutionsService.create(body);
    };
    // @UseGuards(AtGuard)
    SolutionsController.prototype.findAll = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var solutionsRes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.solutionsService.findAll()];
                    case 1:
                        solutionsRes = _a.sent();
                        return [2 /*return*/, response.status(200).send(solutionsRes)];
                }
            });
        });
    };
    SolutionsController.prototype.search = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.solutionsService.search(query)];
    ...
    SolutionsController.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.solutionsService.findOne(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    SolutionsController.prototype.update = function (id, body) {
    ...
    __decorate([
        ...
        (0, common_1.Post)(),
        (0, common_1.HttpCode)(common_1.HttpStatus.CREATED) //201
        ,
    ...
    ], SolutionsController.prototype, "search");
    __decorate([
        (0, common_1.UseGuards)(guards_1.AtGuard),
        (0, common_1.Get)(':id'),
        openapi.ApiResponse({ status: 200, type: Object }),
    ...
    __decorate([
        (0, common_1.UseGuards)(guards_1.AtGuard),
        (0, common_1.Patch)(':id'),
        (0, common_1.HttpCode)(common_1.HttpStatus.OK) //200
        ,
